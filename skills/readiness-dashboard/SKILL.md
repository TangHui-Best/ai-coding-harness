...
description: MUST use before non-trivial review, merge, release, handoff, PR readiness, completion claims, progress assessment, maturity assessment, distance to target, roadmap gap, delivery gap, remaining modules, overall progress, 整体进展, 距离目标, 还差多少, 当前成熟度, 交付缺口, roadmap gap, or 功能模块缺口 when Codex needs a readiness rollup without creating new artifacts.
---
...
```text
AgentMentor Readiness Dashboard
...
- Do not create new documents from this skill; route to `knowledge-capture`.
