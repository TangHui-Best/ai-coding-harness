...
- 六个聚焦的 Harness Skill：检索、文档生命周期、事故学习、愿景校验、变更叙事、知识沉淀
...
- Review、Merge、Release、Handoff 前进行 Vision Gate
...
| `harness-vision-gate` | Review、Merge、Done、Release 或 Handoff 前检查是否偏离原始目标。 |
