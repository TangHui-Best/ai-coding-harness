...
This skill governs lifecycle metadata and placement only. If the lifecycle change also changes durable project knowledge, route to `ai-coding-harness-knowledge-capture`.
...
- Writing all knowledge capture from scratch. Use `ai-coding-harness-knowledge-capture`.
...
Route to `ai-coding-harness-knowledge-capture` when a lifecycle change affects any durable knowledge entry:
