...
7. Capture durable knowledge only when future work would benefit.
8. Write a compact change narrative for review, handoff, or history.
9. Run the project-rules gate before promoting any source-backed constraint into `AGENTS.md`.
