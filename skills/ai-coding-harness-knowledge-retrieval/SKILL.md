---
name: ai-coding-harness-knowledge-retrieval
...
Retrieval reads and judges existing knowledge. It does not build indexes, invent a knowledge service, or write durable memory. Route missing or stale durable memory to `ai-coding-harness-knowledge-capture`.
...
- Creating or updating ADRs, Lessons, Feature pages, Evidence, or handoff notes. Use `ai-coding-harness-knowledge-capture`.
